import { DONATION_TYPE, ITEM_TYPE, ROUTE_SUB_TYPE, TXN_TYPE, USER_ROLE } from "./_ssr/common.schema-rOPsTdW8.mjs";
...
import { cn, getUserInfo } from "./_ssr/utils-lKLyXhB7.mjs";
import { Dot, ShoppingCart } from "./_libs/lucide-react.mjs";
import { Button } from "./_ssr/button-Bhg_Lprh.mjs";
import { useSuspenseQuery } from "./_libs/tanstack__react-query.mjs";
import { Card, CardAction, CardContent, CardDescription, CardHeader, CardTitle } from "./_ssr/separator-B8iuesUR.mjs";
import { zt } from "./_libs/react-hot-toast.mjs";
import { CardLoader, itemsOptions, txnsOptions } from "./_ssr/card-loader-B0N-W8_R.mjs";
import { Background } from "./_ssr/background-Bade6QlY.mjs";
import { Route } from "./_committee._subType._year-CoyVpgVT.mjs";
import { SuspenseErrorBoundary } from "./_ssr/suspense-error-boundary-BpLC6vzM.mjs";
import { Amount, AnimatedList, AnimatedListItem, SelectYear, Tabs$1, TabsContent, TabsContents, TabsList, TabsTrigger } from "./_ssr/animated-list-CYIuENrB.mjs";
import { TxnButton, useCart } from "./_ssr/txn-button-CGYoIZAS.mjs";
import { PaginationComponent, TxnActions } from "./_ssr/pagination-98Il7YM-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/_committee._subType._year-CO5hnS6g.js
var import_jsx_runtime = require_jsx_runtime();
function ItemBookingContent() {
	const { committee, subType, year } = Route.useParams();
	const { auth } = Route.useRouteContext();
	const { page = 0 } = Route.useSearch();
	const { data: pageResp } = useSuspenseQuery({ ...txnsOptions({
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
			...
			children: [
				...
				auth.role === USER_ROLE.ADMIN && subType === ROUTE_SUB_TYPE.ANNADAAN && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardDescription, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectYear, {
					year,
					handleSelect
				}) }),
