...
import { Primitive, createSlot, dispatchDiscreteCustomEvent, require_jsx_runtime, useComposedRefs } from "./react-arrow+[...].mjs";
import { composeEventHandlers } from "../radix-ui__primitive.mjs";
import { createContextScope } from "./react-collection+[...].mjs";
...
//#endregion
export { Dialog, DialogClose, DialogContent, DialogDescription, DialogOverlay, DialogPortal, DialogTitle, DialogTrigger, DismissableLayer, FocusScope, Portal, Presence, ReactRemoveScroll, hideOthers, useCallbackRef$1 as useCallbackRef, useControllableState, useFocusGuards, useId, useLayoutEffect2 };
