...
//#endregion
export { Symbol, area_default, basisClosed_default, basisOpen_default, basis_default, bumpX, bumpY, circle_default, cross_default, diamond_default, expand_default, line_default, linearClosed_default, linear_default, monotoneX, monotoneY, natural_default, none_default, none_default$1, silhouette_default, square_default, stack_default, star_default, stepAfter, stepBefore, step_default, triangle_default, wiggle_default, wye_default };
