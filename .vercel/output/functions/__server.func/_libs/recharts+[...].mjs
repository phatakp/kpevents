...
import { get, isPlainObject, range, sortBy as sortBy$1, throttle, uniqBy } from "./es-toolkit.mjs";
import { autoBatchEnhancer, combineReducers, configureStore, createAction, createListenerMiddleware, createSlice, current, prepareAutoBatched } from "./@reduxjs/toolkit+[...].mjs";
import { castDraft } from "./immer.mjs";
import { Provider_default, shallowEqual } from "./react-redux+[...].mjs";
import { decimal_default } from "./decimal.js-light.mjs";
import { band, diverging, divergingLog, divergingPow, divergingSqrt, divergingSymlog, identity, implicit, linear, log, ordinal, point, pow, quantile, quantize, radial, sequential, sequentialLog, sequentialPow, sequentialQuantile, sequentialSqrt, sequentialSymlog, sqrt, symlog, threshold, tickFormat, time, utcTime } from "./d3-scale+[...].mjs";
import { eventemitter3_default } from "./eventemitter3.mjs";
import { require_react_is } from "./react-is.mjs";
...
var Surface = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var { children, width, height, viewBox, className, style, title, desc } = props, others = _objectWithoutProperties$18(props, _excluded$18);
	var svgView = viewBox || {
		width,
		height,
		x: 0,
...
var Layer = /*#__PURE__*/ import_react.forwardRef((props, ref) => {
	var { children, className } = props, others = _objectWithoutProperties$17(props, _excluded$17);
...
var Symbols = (_ref) => {
	...
	*/
	...
	if (isNumber(cx) && isNumber(cy) && isNumber(size)) return /*#__PURE__*/ import_react.createElement("path", _extends$20({}, filteredProps, {
...
var appendOffsetOfLegend = (offset, legendSettings, legendSize) => {
	if (legendSettings && legendSize) {
		...
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$34(_objectSpread$34({}, offset), {}, { [align]: offset[align] + (boxWidth || 0) });
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$34(_objectSpread$34({}, offset), {}, { [verticalAlign]: offset[verticalAlign] + (boxHeight || 0) });
	}
	return offset;
};
...
function getTooltipEntry(_ref4) {
	...
	return _objectSpread$34(_objectSpread$34({}, tooltipEntrySettings), {}, {
		dataKey,
		payload,
		value,
		name
...
var selectChartOffsetInternal = createSelector([
	...
	var offset = _objectSpread$33(_objectSpread$33({}, {
	...
	return _objectSpread$33(_objectSpread$33({ brushBottom }, offset), {}, {
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent = () => {
		if (payload && payload.length) {
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				var finalItemStyle = _objectSpread$31(_objectSpread$31({}, defaultDefaultTooltipContentProps.itemStyle), {}, { color: entry.color || defaultDefaultTooltipContentProps.itemStyle.color }, itemStyle);
	...
	var finalStyle = _objectSpread$31(_objectSpread$31({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function TooltipBoundingBoxImpl(props) {
	...
	var outerStyle = _objectSpread$30(_objectSpread$30({}, props.hasPortalFromProps ? {} : _objectSpread$30(_objectSpread$30({ transition: resolveTransitionProperty({
...
var getPath$1 = (_ref) => {
	...
	if (Array.isArray(baseLine)) {
		var _lineFunction;
		var areaPoints = points.map((entry, index) => _objectSpread$29(_objectSpread$29({}, entry), {}, { base: baseLine[index] }));
...
var Cross = (_ref) => {
	var { x = 0, y = 0, top = 0, left = 0, width = 0, height = 0, className } = _ref, rest = _objectWithoutProperties$15(_ref, _excluded$15);
	var props = _objectSpread$28({
		x,
		y,
		top,
		left,
...
*/
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$27(_objectSpread$27({}, res), {}, { [key]: fn(key, obj[key]) }), {});
//#endregion
...
var calStepperVals = (easing, preVals, steps) => {
	var nextStepVals = mapObject((key, val) => {
		if (needContinue(val)) {
			...
			return _objectSpread$26(_objectSpread$26({}, val), {}, {
				from: newX,
				velocity: newV
			});
		}
	...
	if (steps < 1) return mapObject((key, val) => {
		if (needContinue(val) && nextStepVals[key] != null) return _objectSpread$26(_objectSpread$26({}, val), {}, {
...
function createStepperUpdate(from, to, easing, interKeys, render, timeoutController) {
	var preTime;
	var stepperStyle = interKeys.reduce((res, key) => _objectSpread$26(_objectSpread$26({}, res), {}, { [key]: {
		from: from[key],
		velocity: 0,
		to: to[key]
	} }), {});
	...
	var stepperUpdate = (now) => {
		...
		render(_objectSpread$26(_objectSpread$26(_objectSpread$26({}, from), to), getCurrStyle()));
		preTime = now;
...
function createTimingUpdate(from, to, easing, duration, interKeys, render, timeoutController) {
	...
	var timingStyle = interKeys.reduce((res, key) => {
		...
		return _objectSpread$26(_objectSpread$26({}, res), {}, { [key]: [fromElement, toElement] });
	}, {});
	var beginTime;
	var timingUpdate = (now) => {
		...
		render(_objectSpread$26(_objectSpread$26(_objectSpread$26({}, from), to), currStyle));
		if (t < 1) stopAnimation = timeoutController.setTimeout(timingUpdate);
			...
			render(_objectSpread$26(_objectSpread$26(_objectSpread$26({}, from), to), finalStyle));
		}
	};
	return () => {
...
var configUpdate_default = (from, to, easing, duration, render, timeoutController) => {
	...
	if (easing == null) return () => {
		render(_objectSpread$26(_objectSpread$26({}, from), to));
		return () => {};
	};
...
*/
var _excluded$14 = ["radius"], _excluded2$7 = ["radius"];
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		var _svgPropertiesAndEven = svgPropertiesAndEvents(props), { radius: _ } = _svgPropertiesAndEven, otherPathProps = _objectWithoutProperties$14(_svgPropertiesAndEven, _excluded$14);
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var _svgPropertiesAndEven2 = svgPropertiesAndEvents(props), { radius: _ } = _svgPropertiesAndEven2, otherPathProps = _objectWithoutProperties$14(_svgPropertiesAndEven2, _excluded2$7);
		return /*#__PURE__*/ import_react.createElement("path", _extends$15({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	var _resolveDefaultProps = resolveDefaultProps(outsideProps, textDefaultProps), { x: propsX, y: propsY, lineHeight, capHeight, fill, scaleToFit, textAnchor, verticalAnchor } = _resolveDefaultProps, props = _objectWithoutProperties$12(_resolveDefaultProps, _excluded$12);
	...
	var { dx, dy, angle, className, breakAll } = props, textProps = _objectWithoutProperties$12(props, _excluded2$6);
...
var getCartesianPosition = (options) => {
	...
	if (position === "insideLeft") return _objectSpread$12({
		x: middleX + horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$12({
		x: middleX + midHeightWidth - horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$12({
		x: upperX + upperWidth / 2,
		y: y + verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$12({
		x: lowerX + lowerWidth / 2,
		y: y + height - verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$12({
		x: upperX + horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$12({
		x: upperX + upperWidth - horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$12({
		x: lowerX + horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$12({
		x: lowerX + lowerWidth - horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$12({
...
var _excluded$11 = ["labelRef"], _excluded2$5 = ["content"];
...
function Label(outerProps) {
	...
	var propsWithViewBox = _objectSpread$11(_objectSpread$11({}, props), {}, { viewBox });
	if (/*#__PURE__*/ (0, import_react.isValidElement)(content)) {
		var { labelRef: _ } = propsWithViewBox;
		return /*#__PURE__*/ (0, import_react.cloneElement)(content, _objectWithoutProperties$11(propsWithViewBox, _excluded$11));
	}
	if (typeof content === "function") {
		var { content: _2 } = propsWithViewBox;
		label = /*#__PURE__*/ (0, import_react.createElement)(content, _objectWithoutProperties$11(propsWithViewBox, _excluded2$5));
...
function LabelList(_ref) {
	var { valueAccessor = defaultAccessor } = _ref, restProps = _objectWithoutProperties$10(_ref, _excluded$10);
	var { dataKey, clockWise, id, textBreakAll, zIndex } = restProps, others = _objectWithoutProperties$10(restProps, _excluded2$4);
...
var Trapezoid = (outsideProps) => {
	...
	if (!isUpdateAnimationActive) return /*#__PURE__*/ import_react.createElement("g", null, /*#__PURE__*/ import_react.createElement("path", _extends$9({}, svgPropertiesAndEvents(trapezoidProps), {
		className: layerClass,
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		return /*#__PURE__*/ import_react.createElement("path", _extends$9({}, svgPropertiesAndEvents(trapezoidProps), {
			className: layerClass,
			d: getTrapezoidPath(currX, currY, currUpperWidth, currLowerWidth, currHeight),
			ref: pathRef,
			style: _objectSpread$10(_objectSpread$10({}, animationStyle), trapezoidProps.style)
		}));
	});
};
//#endregion
...
var _excluded$7 = [
	...
	"y2",
	"key"
], _excluded2$3 = ["offset"], _excluded3$2 = ["xAxisId", "yAxisId"], _excluded4$1 = ["xAxisId", "yAxisId"];
...
function LineItem(_ref) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) lineItem = /*#__PURE__*/ import_react.cloneElement(option, lineItemProps);
		...
		var _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(_objectWithoutProperties$7(lineItemProps, _excluded$7))) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, { offset: __ } = _ref2, restOfFilteredProps = _objectWithoutProperties$7(_ref2, _excluded2$3);
...
//#endregion
export { Bar, BarChart, CartesianGrid, LabelList, Rectangle, ResponsiveContainer, Tooltip, XAxis };
