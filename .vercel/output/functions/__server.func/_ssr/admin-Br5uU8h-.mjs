...
import { QUERY_KEYS } from "./common.schema-CKnvY_hu.mjs";
...
import { approveMember, deleteMember, pendingMemberOptions } from "./admin.queries-BOrzEKU7.mjs";
import { zt } from "../_libs/react-hot-toast.mjs";
import { Background } from "./background-Cjri-gEp.mjs";
import { SuspenseErrorBoundary } from "./suspense-error-boundary-9oqj6wJ3.mjs";
require_react();
...
function useApproveMember() {
	...
	return useMutation({
		...
		onSuccess: () => {
			...
			return queryClient.invalidateQueries({ queryKey: QUERY_KEYS.approveMember });
		},
		onError: (error) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Background, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PendingMembers, {})
			})]
		})
	});
}
