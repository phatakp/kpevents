...
import { Route as Route$4, getContext } from "./card-loader-B0N-W8_R.mjs";
import { Route as Route$5 } from "../_committee._subType._year-CoyVpgVT.mjs";
import { Route as Route$6 } from "../_committee._year-B_RcniLE.mjs";
import { Route as Route$7 } from "./dashboard-Cs3vIMai.mjs";
import { Route as Route$8 } from "./transactions._committee._type._year-BOkGC4rL.mjs";
import { setupRouterSsrQueryIntegration } from "../_libs/@tanstack/react-router-ssr-query+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-BEhwebfh.js
...
var $$splitComponentImporter$3 = () => import("./admin-C1DqJb3u.mjs");
...
var rootRouteChildren = {
	...
	AdminRoute,
	DashboardRoute,
	CommitteeYearRoute: Route$6.update({
		id: "/$committee/$year",
		path: "/$committee/$year",
		getParentRoute: () => Route$4
	}),
	SignInSplatRoute,
	SignUpSplatRoute,
	CommitteeSubTypeYearRoute: Route$5.update({
