...
import { BuildingSchema, CommitteeSchema, DONATION_TYPE, DonationTypeSchema, ItemTypeSchema, TXN_TYPE, TxnModeSchema, TxnTypeSchema } from "./common.schema-rOPsTdW8.mjs";
import { getFlatsForBuilding } from "./utils-lKLyXhB7.mjs";
import { FlatNumberSchema, UserShortSchema } from "./user.schema-CA2vovpU.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/txn.schema-DT3-__5q.js
...
TransactionFormSchema.omit({ flatNumber: true }).extend({
	donorBuilding: v4_default.union([BuildingSchema, v4_default.undefined()]),
	donorFlat: v4_default.coerce.number().optional()
});
