...
import { FastResponse, H3Core, HTTPError, defineLazyEventHandler } from "./_libs/h3+rou3+srvx.mjs";
...
var _lazy_5unhO5 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_5unhO5
	};
	return ((_m, p) => {
		return {
			data,
